...
-- 학과별 정원 
------------------------------------------------ 
-- 국어국문학과의 정원은 20명 입니다. 영어영문학과의 정원은 36명 입니다.
-- 사학과의 정원은 28명 입니다. 철학과의 정원은 28명 입니다. ...
...
select student_name
from tb_student
where tb_student.department_no = 001 and 
      mod(substr(student_ssn,8,1),2)=0 and
      absence_yn = 'Y';
...
-- 10. 02학번 전주 거주자들의 모임을 맊들려고 핚다. 
-- 휴학한 사람들은 제외하고 재학중인 학생들의 
